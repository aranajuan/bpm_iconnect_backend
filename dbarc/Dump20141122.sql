...
INSERT INTO `acciones` VALUES (1,'ABRIR','ABRIR','Pendiente','open',1,1,NULL,0,2,'5,',2,2,0,0,'({idmaster}==NULL && {fb}==NULL )(to:{team}::cc:{team_profile=>coordinador})','Se ha generado un nuevo tkt derivado al area.<br />\nID: {id}<br />\nSistema: {system->name}<br />\nPuedes verlo en <a href=\"{html_dir}staffhome.php\">ITRACKER</a>','Genera un nuevo ticket',0),(2,'CERRAR','CERRAR','Cerrado','close',1,1,'\n<itform>\n  <element>\n    <label>Comentario</label>\n    <type>inputlong</type>\n    <id>comment</id>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n</itform>',1,1,'',0,1,1,1,'(1==1)(to:{clients}::cc:{team})','Se ha solucionado un tkt que generaste.<br/>ID: {id}<br />Sistema: {system->name}<br />Puedes ver la solucion en <a href=\"{html_dir}mytkts.php\">ITRACKER</a> en la lista de los ultimos solucionados.<b>No olvides dar tu conformidad!</b>','Indicar que el ticket esta solucionado',0),(3,'LIBERAR','LIBERAR',NULL,'free',2,0,NULL,1,1,'3,4,',0,1,1,1,'','','Libera el ticket para que lo pueda tomar otro usuario.',0),(4,'DERIVAR','DERIVAR','derivado','derive',2,1,'\n<itform> 	<element> 		<label> 			Equipo a derivar 		</label> 		<notsave>true</notsave> 		<type> 			idsel 		</type> 		<id> 			idequipo 		</id> 		<idselparams> 			<class>tkt</class> 			<method>idsel_teamderive</method> 		</idselparams> 		<validations> 			<required>true</required> 			<numeric>true</numeric> 		</validations>		 	</element> 	<element> 		<type> 			inputlong 		</type> 	<label>Comentario</label>	<id> 			comment 		</id> 		<comment> 			Commentario 		</comment> 	</element> </itform>',1,1,'3,4,',0,1,1,1,'(1==1)(to:{team}::cc:{prev_team})','{prev_team->name} ha derivado un tkt al area.<br />\nID: {id}<br />\nApertura: {FA}<br />\nSistema: {system->name}<br />\nPuedes verlo en <a href=\"{html_dir}staffhome.php\">ITRACKER</a>','Asignar el ticket a otro equipo',0),(5,'TOMAR','TOMAR','en analisis','take',2,0,NULL,0,2,'3,4,',0,1,1,1,'(1==1)(to:{clients})','Tu tkt {id} ha sido tomado por {u_tom->name} y esta siendo tratado.<br />Se te comunicar&aacute; por este medio los avances. Asi mismo puedes darle seguimenteo en <a href=\"{html_dir}mytkts.php\">ITRACKER</a>.','Reservar el ticket para su tratamiento',0),(6,'REABRIR','RE ABRIR','re abierto','reopen',1,1,'<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		<validations> 			<required>true</required> 		</validations> 	</element> </itform>',1,0,'3,4,',0,2,1,1,'','','Libera el ticket para que lo pueda tomar otro usuario.',0),(7,'SET_MASTER','Set master',NULL,'setmaster',1,0,NULL,1,0,'3,4,',0,1,1,2,'','',NULL,0),(8,'ASIGNAR','Asignar',NULL,'asign',2,1,'<itform>\n  <element>\n    <label>Asignar a:</label>\n    <notsave>true</notsave>\n    <type>idsel</type>\n    <id>idusr</id>\n    <idselparams>\n      <class>tkt</class>\n      <method>idsel_userasign</method>\n    </idselparams>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n  <element>\n    <type> 			inputlong 		</type>\n    <label>Comentario</label>\n    <id> 			comment 		</id>\n    <comment> 			Commentario 		</comment>\n  </element>\n</itform>',0,2,'4,',0,1,1,1,'(1==1)(to:{u_tom})','Se te ha asignado el tkt {id} del sistema {system->name}.<br />\nPuedes verlo en <a href=\"{html_dir}staffhome.php\">ITRACKER</a>.\n','Asignar el ticket a un miembro del equipo',0),(12,'PRIORIZAR','Priorizar',NULL,'priorice',3,1,'<itform> 	<element> 		<label> 			Prioridad: 		</label> 		<notsave>true</notsave> 		<type> 			select 		</type> 		<id> 			prioridad 		</id> 		<option><value>3</value><text>ALTA</text></option> 		<option><value>6</value><text>MEDIA</text></option> 		<option><value>9</value><text>BAJA</text></option> 		<validations> 			<required>true</required> 			<numeric>true</numeric> 		</validations>		 	</element>	 </itform>',0,0,'4,',0,1,1,1,'({u_tom}!=NULL)(to:{u_tom})$$(u_tom==NULL)(to:{team})','Se cambio la prioridad del tkt {id} del sistema {system->name}.<br/>\nActualmente tomado por {u_tom->name}.<br/>\nPuedes verlo en <a href=\"{html_dir}staffhome.php\">ITRACKER</a>.','Establece una nueva prioridad al ticket',0),(14,'UNIR','Unir',NULL,'join',1,1,'<itform> 	<element> 		<label> 			Unir a id: 		</label> 		<notsave>true</notsave> 		<type> 			input 		</type> 		<id> 			idmaster 		</id> 		<validations> 			<required>true</required> 			<numeric>true</numeric> 		</validations>		 	</element>	 </itform>',1,1,'3,4,',0,1,1,1,'','','Relaciona el ticket a otro',0),(15,'SEPARAR','Separar',NULL,'unjoin',1,0,NULL,1,1,'3,4,',0,1,1,2,'','','Elimina la relacion al ticket padre',0),(16,'CERRAR_COMISIONES_PROCEDENTE','Cerrar Procedente','cerrado','close',1,1,'<itform>\n  <element>\n    <label>Tipo cierre</label>\n    <id>tipocierre</id>\n    <type>select</type>\n    <option>\n      <value>1</value>\n      <text>Procedente</text>\n    </option>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n    <label>Monto a ajustar</label>\n    <type>input</type>\n    <id>monto</id>\n    <comment>(Punto separador decimal)</comment>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n    <label>Cantidad de operaciones</label>\n    <type>input</type>\n    <id>qoper</id>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n   <label>Se ajustara en el mes</label>\n    <type>month</type>\n    <id>majust</id>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n <element>\n    <label>Adjunto</label>\n    <type>fileupl</type>\n    <id>adjunto</id>\n    <notsave>true</notsave>\n  </element>\n  <element>\n    <label> 			Comentario 		</label>\n    <type> 			inputlong 		</type>\n    <id> 			comment 		</id>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n</itform>',1,1,'3,4,',0,1,1,1,'','','cerrar comisiones procedente',0),(17,'CERRAR_COMISIONES_NOPROCE','Cerrar No Procedente','cerrado','close',1,1,'<itform>\n  <element>\n    <label>Tipo cierre</label>\n    <id>tipocierre</id>\n    <type>select</type>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n    <label>Monto a ajustar</label>\n    <type>input</type>\n    <id>monto</id>\n    <comment>(Punto separador decimal)</comment>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n    <label>Cantidad de operaciones</label>\n    <type>input</type>\n    <id>qoper</id>\n    <validations>\n      <required>true</required>\n      <numeric>true</numeric>\n    </validations>\n  </element>\n  <element>\n   <label>Se ajustara en el mes</label>\n    <type>date</type>\n    <id>qoper</id>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n <element>\n    <label>Adjunto</label>\n    <type>fileupl</type>\n    <id>adjunto</id>\n    <notsave>true</notsave>\n  </element>\n  <element>\n    <label> 			Comentario 		</label>\n    <type> 			inputlong 		</type>\n    <id> 			comment 		</id>\n    <validations>\n      <required>true</required>\n    </validations>\n  </element>\n</itform>',1,1,'3,4,',0,1,1,1,'','','cerrar comisiones no procedente',0),(18,'REABRIR_COOR','Reabrir','re abierto','reopen',1,1,'<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		<validations> 			<required>true</required> 		</validations> 	</element> </itform>',2,0,'4,',0,2,1,1,'','','reabrir coordinador',0),(19,'LIBERAR_COOR','Liberar','','free',2,0,NULL,2,1,'4,',0,1,1,1,'','','librerar coordinador',0),(20,'COMENTARIO_GENERADOR','COMENTARIO',NULL,'',1,1,'<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		<validations> 			<required>true</required> 		</validations> 	</element> </itform>',0,0,'5,',1,0,0,0,'','','comentario cliente',0),(21,'COMENTARIO_EQUIPO','COMENTARIO',NULL,'',1,1,'<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		<validations> 			<required>true</required> 		</validations> 	</element> </itform>',0,0,'3,4,',2,0,1,0,'','','comentario equipo',0);
...
INSERT INTO `listines` VALUES (1,'Comisiones','','','0'),(2,'Go_comisiones','','','0'),(3,'Agente1','','','0'),(4,'Agente2','','','0'),(5,'Adms','','','0');
...
-- Dump completed on 2014-11-22 21:39:20
...
INSERT INTO `tickets` VALUES (1,'U1AG1',NULL,'D1-S1-O3-O6-O10-',1,'COMGO',NULL,NULL,'2014-11-22 17:33:42','U1AG1',NULL,NULL),(2,'U2AG1',NULL,'D1-S1-O4-O9-O14-',2,'COM1',NULL,NULL,'2014-11-22 17:53:44','U2AG1','2014-11-22 19:21:53','COM1');
...
INSERT INTO `tickets_m` VALUES (1,1,1,'2','2014-11-22 17:33:42','U1AG1','2014-11-22 18:40:53','U1AG1',0),(2,2,1,'2','2014-11-22 17:53:44','U2AG1','2014-11-22 19:10:15','COM1',0),(3,1,20,'','2014-11-22 18:40:53','U1AG1','2014-11-22 19:09:48','COM1',0),(4,1,5,'','2014-11-22 19:09:48','COM1','2014-11-22 19:10:05','COM1',0),(5,1,4,'1','2014-11-22 19:10:05','COM1','2014-11-22 20:12:07','COMGO',0),(6,2,5,'','2014-11-22 19:10:15','COM1','2014-11-22 19:21:53','COM1',0),(7,2,16,'','2014-11-22 19:21:53','COM1',NULL,NULL,0),(8,1,5,'','2014-11-22 20:12:07','COMGO','2014-11-22 20:12:20','COMGO',0),(9,1,21,'','2014-11-22 20:12:20','COMGO',NULL,NULL,0);
...
INSERT INTO `tickets_m_detalles` VALUES (1,'<?xml version=\"1.0\"?>\n<itform>\n <element><type>input</type><label>legajo</label><id>Hola</id><value>12343</value></element> <element><type>text</type><id>juan</id><text>holatext este si es largo para verificar el contenido alargado a su maxima longitud</text><value/></element> <element><type>input</type><id>21</id><comment>3 usuarios de ejemplo</comment><label>usuarios</label><value>U111111</value></element> <element><type>inputlong</type><label>comentario</label><id>2</id><value>asdasdasssa</value></element> <element><type>datetime</type><id>date</id><label>Fecha</label><value/></element> <element><type>date</type><id>32</id><label>Fecha</label><value/></element> <element><type>select</type><id>321</id><label>seleccion</label><option><value>1</value><text>opcion1</text></option><option><value>2</value><text>opcion2</text></option><value>2</value></element> <element><type>link</type><id>322</id><label>wAnexo</label><path>siebel/aa/dd.ppt</path><text>Link</text><comment>Descargue el archivo para luego anexarlo</comment><value/></element> </itform>\n'),(2,'<?xml version=\"1.0\"?>\n<itform>\n <element><type>input</type><label>legajo</label><id>Hola</id><value>3434</value></element> <element><type>text</type><id>juan</id><text>holatext este si es largo para verificar el contenido alargado a su maxima longitud</text><value/></element> <element><type>input</type><id>21</id><comment>3 usuarios de ejemplo</comment><label>usuarios</label><value>U123456</value></element> <element><type>inputlong</type><label>comentario</label><id>2</id><value/></element> <element><type>datetime</type><id>date</id><label>Fecha</label><value>20-11-2014 00:00</value></element> <element><type>date</type><id>32</id><label>Fecha</label><value/></element> <element><type>select</type><id>321</id><label>seleccion</label><option><value>1</value><text>opcion1</text></option><option><value>2</value><text>opcion2</text></option><value>1</value></element> <element><type>link</type><id>322</id><label>wAnexo</label><path>siebel/aa/dd.ppt</path><text>Link</text><comment>Descargue el archivo para luego anexarlo</comment><value/></element> </itform>\n'),(3,'<?xml version=\"1.0\"?>\n<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		 	<value>por favor ver con celeridad</value></element> </itform>\n'),(5,'<?xml version=\"1.0\"?>\n<itform> 	 	<element> 		<type> 			inputlong 		</type> 	<label>Comentario</label>	<id> 			comment 		</id> 		<comment> 			Commentario 		</comment> 	<value>im12345</value></element> </itform>\n'),(7,'<?xml version=\"1.0\"?>\n<itform>\n  <element>\n    <label>Tipo cierre</label>\n    <id>tipocierre</id>\n    <type>select</type>\n    <option>\n      <value>1</value>\n      <text>Procedente</text>\n    </option>\n    \n  <value>1</value></element>\n  <element>\n    <label>Monto a ajustar</label>\n    <type>input</type>\n    <id>monto</id>\n    <comment>(Punto separador decimal)</comment>\n    \n  <value>100.50</value></element>\n  <element>\n    <label>Cantidad de operaciones</label>\n    <type>input</type>\n    <id>qoper</id>\n    \n  <value>10</value></element>\n  <element>\n   <label>Se ajustara en el mes</label>\n    <type>month</type>\n    <id>majust</id>\n    \n  <value>03-2007</value></element>\n \n  <element>\n    <label> 			Comentario 		</label>\n    <type> 			inputlong 		</type>\n    <id> 			comment 		</id>\n    \n  <value>ok</value></element>\n</itform>\n'),(9,'<?xml version=\"1.0\"?>\n<itform> 	<element> 		<label> 			Comentario 		</label> 		<type> 			inputlong 		</type> 		<id> 			comment 		</id> 		 	<value>se esta analizando</value></element> </itform>\n');
...
INSERT INTO `sesiones` VALUES ('COM1','190.175.110.1',1,'776767e792d7afe36f9e8c9aa37d146db2f309d4','2014-11-22 19:09:08'),('COMGO','190.175.110.1',1,'bdbb102b38ec6e6ceeb0a81c4bb062ab20912fb2','2014-11-22 20:11:39'),('COMRES','190.175.110.1',1,'f12d60f9e76b5f31b3ceeb8f4a008a9b15e9cf60','2014-11-22 20:13:57'),('FEDE','190.175.110.1',1,'33ee60641582d6c6a242d1d98fd1c31e8be71b1e','2014-11-22 12:15:27'),('FULLADM','190.175.110.1',1,'1a81fd17bb78390f34b112235269d125f3150300','2014-11-22 20:15:46'),('U1AG1','190.175.110.1',1,'35db57e570c82fc9419b50740c9427257267fbd3','2014-11-22 20:15:30'),('U1AG2','190.175.110.1',1,'8facbd022757f9af005a3712a0a339d1071b6c75','2014-11-22 19:22:58'),('U2AG1','190.175.110.1',1,'5775975f47bf6c399180e57f7cac0f282f1add12','2014-11-22 19:23:27');
